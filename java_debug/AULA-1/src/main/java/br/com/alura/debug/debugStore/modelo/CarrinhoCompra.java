	...
	public BigDecimal calcularPrecoFinal(List<Produto> produtos) {
		...
		for (Produto produto : produtos) {
			...
			if(valorProdutoComDesconto.compareTo(new BigDecimal("700.00")) == 1) {
				System.out.println("O produto é acima de 700 " + produto.getDescricao() + " ganhou mais R$20 de desconto " );
				valorProdutoComDesconto = valorProdutoComDesconto.subtract(new BigDecimal("20"));
			}
